					...
					foreach ($result as $value){
						echo '<div class="film row">';
							...
							echo '<div class="filmiinfoblokk col-xs-12 col-sm-10 col-md-10">';
								echo '<div class="filmiinfo col-xs-6 col-sm-3 col-md-3"><b>Riik</b><br />' . $value["DescriptionCountry"] .'</div>';
								echo '<div class="filmiinfo col-xs-6 col-sm-3 col-md-3"><b>Režissöör</b><br />' . $value["DescriptionFilmDirector"] .'</div>';
								echo '<div class="filmiinfo col-xs-6 col-sm-3 col-md-3"><b>Pikkus</b><br />' . $value["DescriptionRunningTime"] .'</div>';
